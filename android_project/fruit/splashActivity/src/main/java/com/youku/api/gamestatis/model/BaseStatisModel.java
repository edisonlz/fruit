...
public class BaseStatisModel extends BaseModel {
	
	
    String Path = "basic/statis/getdata";
	
	
	public BaseStatisModel(Context context){
		super(context);
	}
	
    public void get(String product,int platform,int device,final HttpCallBackHandler callbackhandler) {
